...
const sendShieldedTransaction = async (signer, destination, data, value) => {
  ...
  async function main() {
    ...
    const contractAddress = "0xd0DF14e53403E920C0600df4f1247020CCFd6356"; 
    ...
    console.log("Transaction Response: ", `Transfer token has been successful! Transaction hash: https://explorer-evm.testnet.swisstronik.com/tx/${transferTx.hash}`);
